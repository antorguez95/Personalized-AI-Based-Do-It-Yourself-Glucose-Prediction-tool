...
def get_grouped_RMSEbased_best_metrics(exp_config : Dict, grouped_metrics : Dict,
    ...
    It also returns the IDs of the patients to access easily to their data. 
...
def get_global_MSEbased_graphics(PH : int, best_model_dict : Dict, ids : List) : 
    ...
    plot the results joining metrics, models and patients. RMSE, MAPE and MAE are studied.  
...
def get_XY_vectors_characterization(patients_ids : List, PH : int, unit : str = 'mg/dL'):
    ...
    """
    In order to analyse the limitations of the DL models accordinf to each patients, 
