...
# The execution of this script generates a .csv file with the format of the LibreView-generated files.
...
# trends do not intend to imitate real individual's phisiolgy or interstitial glucose patterns. This is just
